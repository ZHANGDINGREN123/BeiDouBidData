...
def Fault_Word_Cloud(dateBegin,dateEnd):
    ...
    d3 = {k: v for k, v in d.items() if v > 2}
    c.close()
    conn.close()
    return d3
...
# print(e)
# print(sorted(e,key=lambda x:e[x])[-1])
# print(sorted(Fault_Word_Cloud(dateBegin,dateEnd),key=lambda x:(Fault_Word_Cloud(dateBegin,dateEnd))[x])[-1])
# print(sorted(Fault_Word_Cloud(dateBegin,dateEnd),key=lambda x:(Fault_Word_Cloud(dateBegin,dateEnd))[x])[-2])
